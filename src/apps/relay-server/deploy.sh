#!/usr/bin/env bash
# Sparo OS Relay Server — one-click deploy script.
...
usage() {
  cat <<'EOF'
Sparo OS Relay Server deploy script
...
echo "=== Sparo OS Relay Server Deploy ==="
...
echo ""
echo "Custom Server URL examples for Sparo OS Desktop:"
